...
iswords = \lyricmode {
 ...
 小 寶 貝， 若 是 你 走 迷 路， 千 萬 不 要 驚 慌， 讓 我 照 著 你 的 路 噢
 我 像 天 空 閃 爍 繁 星， 我 的 光 儘 管 微 小， 我 仍 努 力 把 愛 分 享 播 揚

 你 的 媽 媽 你 的 爸 爸 在 家 等 待 著 你
 別 讓 他 們 焦 慮 擔 憂
 在 這 森 林 我 為 你 守 護 著 珍 寶
 明 天 我 們 再 相 聚
 親 愛 的 你 是 否 到 這 森 林 尋 找 屬 你 的 天 地 屬 你 的 快 樂
...
isMusic = \relative c' {
 ...
 { des bes ges8 aes bes4~ | bes aes des,8 (ees) f4 | ges aes bes c | des2. c4 | des1 | }
 { r2 f,8 ges aes4~ | aes2 ees'8 (des) c4~ | c des c f, | aes2 bes8 (c) des4~ | }
 { des bes aes ges | aes2 des,8 (ees) f4~ | f ges8 f ges4 aes | ees2 e4 (fis~) \key e \major | }
 { fis r gis8 (a) b4~ | b2 dis8 (cis) b4~ | b4 e dis gis, | b2 cis8 dis e4~ | }
 { e cis a8 (b) cis4~ | cis b e,8 fis gis4 | a gis a b | fis2. e4 | e1 | }
 ...
 { r2 cis'8 (dis) e4 | b2 gis8 (fis) e4 | dis1 | f1 }
 { \key ees \major | }
